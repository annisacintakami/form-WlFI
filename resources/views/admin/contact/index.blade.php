                    ...
                    <tbody>
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="text-danger bg-light px-2 py-1 rounded">{{ $contact->mac_address ?? '-' }}</code>
                                </td>
                                <td>
                                    @if($contact->reply)
                                    ...
                                    <div class="modal-content border-0 shadow">
                                        <form action="{{ route('contactadmin.reply', $contact->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="reply{{ $contact->id }}" class="form-label text-muted small fw-bold">Pesan Balasan</label>
                                                    <textarea 
                                                        name="reply" 
                                                        id="reply{{ $contact->id }}"
                                                        class="form-control" 
